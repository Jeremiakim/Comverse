      ...
      <ul className="my-3">
        ...
        <li className="flex w-full px-8 py-2 text-black text-sm">
          <div className="flex flex-row gap-4">
            ...
            >
              <option defaultValue={"1"}>Choose Your Size</option>
        ...
        <div className="flex flex-row mx-[3rem]">
          ...
          <li className="flex-2 my-[0.7rem] mr-[1rem]">
            <div className="flex font-medium items-center justify-center px-1 py-1 relative text-3xl text-black hover:text-red-700 rounded-lg hover:bg-white transition delay-150 duration-500">
